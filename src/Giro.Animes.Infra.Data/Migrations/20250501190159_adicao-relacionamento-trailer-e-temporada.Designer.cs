...
namespace Giro.Animes.Infra.Data.Migrations
{
    ...
    [Migration("20250501190159_adicao-relacionamento-trailer-e-temporada")]
    partial class adicaorelacionamentotraileretemporada
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Giro.Animes.Domain.Entities.Season", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("seasons", "content");
                });

            modelBuilder.Entity("Giro.Animes.Domain.Entities.SeasonSinopse", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("season_sinopses", "content");
                });
            ...
            modelBuilder.Entity("Giro.Animes.Domain.Entities.Trailer", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Giro.Animes.Domain.Entities.Episode", b =>
                {
                    b.HasOne("Giro.Animes.Domain.Entities.Season", "Season")
                        .WithMany("Episodes")
            ...
            modelBuilder.Entity("Giro.Animes.Domain.Entities.Trailer", b =>
                {
                    b.HasOne("Giro.Animes.Domain.Entities.Season", null)
                        .WithOne("Trailer")
                        .HasForeignKey("Giro.Animes.Domain.Entities.Trailer", "SeasonId");
